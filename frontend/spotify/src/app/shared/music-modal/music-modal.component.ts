...
export class MusicModalComponent implements OnInit {
  ...
  constructor(private BandarService:BandaService) {}

  ngOnInit(): void {
    this.BandarService.obterBandas().subscribe(response => {
  ...
  public criar() {
    ...
    reader.onload = (result) => {
      ...
      this.BandarService.criarMusic(request, idBanda as String).subscribe(response => {
        this.onCreated.emit();
